    ...
    if family_code and user_name:
        ...
        if not fam_doc.exists:
            ...
            if data_exp is not None:
                ...
                elif isinstance(data_exp, dict) and "_seconds" in data_exp:
                    data_exp = datetime.datetime.fromtimestamp(data_exp["_seconds"])
                ...
                st.error("Data de expiração da família inválida.")
    else:
